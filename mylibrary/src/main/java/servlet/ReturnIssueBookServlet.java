...
import daoimp.BookIssueDaoImp;
import java.io.IOException;
import java.util.List;

@WebServlet(urlPatterns = "/ReturnIssueBookServlet")
public class ReturnIssueBookServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String studentIdString = request.getParameter("userId");
        int studentId = Integer.parseInt(studentIdString);
     
        String returnDate = request.getParameter("returnDate");
       

        ReturnIIsueBook returnIIsueBook=new ReturnIIsueBook();
        returnIIsueBook.setBookId(bookId);
        returnIIsueBook.setStudentId(studentId);
        returnIIsueBook.setReturnDate(returnDate);
       ...
       boolean bool= bookIssueDao.deleteEntityByStudentAndBookId(studentId, bookId);
       if(bool) {
    	   try (PrintWriter out = response.getWriter()) {
               ...
               out.println("    <p class=\"alert-message\">Deleted Successfully.</p>");
